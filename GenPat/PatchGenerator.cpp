...
PatchGenerator::PatchGenerator(bistream& source, TFileOffset sourceSize, bistream& target, TFileOffset targetSize) :
  source(source), sourceSize(sourceSize), target(target), targetSize(targetSize),
