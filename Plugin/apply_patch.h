...
#define PATCH_UPTODATE      -1
#define PATCH_SUCCESS       0
#define PATCH_ERROR         1
#define PATCH_CORRUPT       2
#define PATCH_NOMATCH       3
#define PATCH_OUTOFMEMORY   4
#define PATCH_BADARGS       5

int DoPatch(HANDLE hPatch, HANDLE hFile, bool hugeFile = false, bool check = false, DWORD preciseOffset = 0);
